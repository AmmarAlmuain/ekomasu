...
export default function Gallery() {
  return (
    <>
      <PhotoProvider>
        <div className="flex w-full max-w-96 max-lg:max-w-full gap-y-4 justify-center items-start flex-col">
          <PhotoView src="https://media.discordapp.net/attachments/1025486564165427353/1194216375598714920/image.png?ex=65af8bab&is=659d16ab&hm=2e4f5dbf06f950cd2bbfad360a673bd53b8af1da37c0534f1d6ecd1abd9a4ac5&=&format=webp&quality=lossless&width=701&height=701">
            <div className="w-full max-w-96 max-sm:border-0 max-sm:rounded-none max-lg:max-w-full h-96 border-2 border-color -center rounded-md">
              <img
                ...
                className="w-[345px] max-lg:max-w-full h-[345px] rounded-md"
              />
            </div>
          </PhotoView>
          <div className="h-14 w-full flex justify-between max-lg:justify-center gap-x-4">
